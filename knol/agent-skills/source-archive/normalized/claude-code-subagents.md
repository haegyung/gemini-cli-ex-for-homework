...
source_group: "anthropic-claude-code"
source_vendor: "Anthropic"
source_topic: "Claude Code Sub-agents"
source_url: "https://code.claude.com/docs/en/sub-agents"
reader_url: "https://r.jina.ai/http://code.claude.com/docs/en/sub-agents"
reader_title: "Create custom subagents - Claude Code Docs"
captured_at: "2026-04-16T03:40:12+00:00"
content_sha256: "582d8f8973d529e4d66d44013518270d2a2e138e0f787c25b77a4d938028b2b4"
---
...
## [​](http://code.claude.com/docs/en/sub-agents#next-steps)

Next steps

Now that you understand subagents, explore these related features:
*   [Distribute subagents with plugins](http://code.claude.com/docs/en/plugins) to share subagents across teams or projects
*   [Run Claude Code programmatically](http://code.claude.com/docs/en/headless) with the Agent SDK for CI/CD and automation
*   [Use MCP servers](http://code.claude.com/docs/en/mcp) to give subagents access to external tools and data
